...
exports.DEFAULT_PATH = createDefaultPath();
exports.DEFAULT_CONFIG_PATH = path.join(exports.DEFAULT_PATH, 'config.json');
exports.DEFAULT_BACKUPS_PATH = createDefaultBackupsPath();


function createDefaultPath() {
    var defaultPath = path.join(os.homedir(), '.mongo-backup-manager');
...
function createDefaultBackupsPath() {
    var defaultBackupsPath = path.join(exports.DEFAULT_PATH, 'backups');

    if (!fs.existsSync(defaultBackupsPath)){
        fs.mkdirSync(defaultBackupsPath);
    }

    return defaultBackupsPath;
}
...
exports.Config = function Config() {
    ...
    this.backupDir = makeGetterSetter({
        defaultVal: exports.DEFAULT_PATH,
        get: function() {
